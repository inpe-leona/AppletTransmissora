...
public class SwingTransmitter extends JFrame {
	...
	public SwingTransmitter() {
		...
		panelServer
				.setLayout(new BoxLayout(panelServer, BoxLayout.LINE_AXIS));
		...
		turnOn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				(threadRTP = new ThreadRTP(Integer.parseInt(port.getText()))).execute();// escolhida a port do socket para a conexao TCP, 
